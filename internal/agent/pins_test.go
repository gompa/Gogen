...
// IsPinned, PinnedIndices, and ListPins are the PinManager's test-only read
// surface, moved out of pins.go: production uses only PinLastUser /
// ClearPins / ReplacePins / PinnedSet.
